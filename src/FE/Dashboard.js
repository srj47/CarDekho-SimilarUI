                ...
                <div className="card">
                  <div className="card-header p-3 pt-2">
                    ...
                    <div className="text-end pt-1">
                      <p className="text-sm mb-0 text-capitalize">New Leads</p>
            ...
            <div className="row mt-4">
              <div className="col-lg-4 col-md-6 mt-4 mb-4">
                <div className="card z-index-2 ">
                  ...
                  <div className="card-body">
                    <h6 className="mb-0 ">Number of leads received</h6>
                ...
                <div className="card z-index-2  ">
                  <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
                    <div className="bg-gradient-success shadow-success border-radius-lg py-3 pe-1">
                      {/* <div className="bg-gradient-primary  shadow-success border-radius-lg py-3 pe-1"> */}
                      <div className="chart">
                        <Chart2 />
                      </div>
                    </div>
                  ...
                  <div className="card-body">
                    <h6 className="mb-0 "> Successfully converted leads</h6>
                    <p className="text-sm ">
                      {" "}
              ...
              <div className="col-lg-4 mt-4 mb-3">
                <div className="card z-index-2 ">
                  ...
                  <div className="card-body">
                    <h6 className="mb-0 ">bank wise loan numbers </h6>
                    <p className="text-sm ">Last Campaign Performance</p>
                    <hr className="dark horizontal" />
                    <div className="d-flex ">
                      <i className="material-icons text-sm my-auto me-1">
