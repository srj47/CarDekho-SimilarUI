      ...
      >
        ...
        >
          <div className="col-12 text-center">
            <h6 className="text-light">Sales Consultant</h6>
          </div>
          <ul className="navbar-nav">
            ...
            <li className="nav-item">
              <Link className="nav-link text-white " to="/CarPage">
                <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i className="material-icons opacity-10">receipt_long</i>
                </div>
                <span className="nav-link-text ms-1">New Enquiry</span>
              </Link>
            </li>
            <li className="nav-item">
              <Link to="/QuotationMaster" className="nav-link text-white ">
                <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i className="material-icons opacity-10">table_view</i>
                </div>
                <span className="nav-link-text ms-1">Quotation Master</span>
              </Link>
            </li>
            <li className="nav-item">
              <Link to="/SCApplication" className="nav-link text-white ">
                <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
